        ...
        <div className="flex flex-col my-15! mx-5!  md:w-3/4 min-h-100 border-2 border-amber-500  bg-[#f6f3e4] shadow-2xl shadow-amber-200 rounded-2xl p-3!">
          <div className='grid grid-cols-1 md:grid-cols-2 place-items-center pt-3!'>
            ...
            <div className='px-3! py-3!'>
              <p className='text-black font-black'>🤗 Welcome to Our BookStore</p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 place-items-center pt-3!'>
            <div className='px-3! py-3!'>
              <p className='text-black font-black'>📚 Our Story</p>
              <hr className="h-px my-3! text-gray-500 border w-9/10 col-span-2" />
              <p className='text-black text-xs md:text-sm text-justify leading-loose'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 place-items-center pt-3!'>
            ...
            />
            <div className='px-3! py-3!'>
              <p className='text-black font-black'>💡 Our Mission</p>
              <hr className="h-px my-3! text-gray-500 border w-9/10 col-span-2" />
              <p className='text-black text-xs md:text-sm text-justify leading-loose'>
